...
\begin{figure*}[!h]
    ...
    \begin{tikzpicture}[baseline=(s12.base)]
        ...
        \draw [->,dashed]      (s11) to (s21) node [draw=none] at (0.5,1) {$/$};
        \draw [->,ultra thick] (s11) to (s22);
        \draw [->,ultra thin]  (s11) to (s23);
        %\draw [->,ultra thin] (s1) to (s6);

        \draw [->,dashed] (s22) to (s32) node [draw=none] at (1.5,0.5) {$/$};
        \draw [->,dashed] (s22) to (s31) node [draw=none] at (1.5,0)     {$/$};
    ...
    \begin{tikzpicture}[baseline=(s1.base)]
        % first-best
        \node[hiddenState] (s1) at (0,0)  {$1$};
        \node[hiddenState] (s2) at (1,0)  {$2$}            
            edge [<-] (s1);
