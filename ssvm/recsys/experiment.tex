...
The {\bf F$_1$ score on pairs}~\cite{cikm16paper} computes the F$_1$ on all ordered pairs in the predicted versus ground truth sequence. %%It is 1 iff both sequences agree completely.
...
% {\tt Osaka} percentage of predictions with loops:
% 11 / 46 = 23.9\% \\
% {\tt Glasgow} percentage of predictions with loops:
% 20 / 64 = 31.2\% \\
% {\tt Toronto} percentage of predictions with loops:
% 48 / 99 = 48.5\% 
...
\begin{figure*}[!t]
	    ...
	    \captionof{figure}{Absolute difference between recommendation and required sequence length for {\sc LoopElim}.}
