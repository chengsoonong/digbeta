...
in the setting of trajectory recommendation, we assume the joint feature map can be decomposed into singleton and pairwise features, i.e.,
\begin{equation}
...
Given a set of POIs $\mathcal{P} = \{p_1, \dots, p_M\}$ and a trajectory query $\mathbf{x} = (p_s, p_e, L)$,
