...
For prediction, we modify the inference procedures to avoid predicting loops in the sequence via the list Viterbi algorithm, an extension of the Viterbi algorithm that sequentially finds a list of top-scoring sequences. 
