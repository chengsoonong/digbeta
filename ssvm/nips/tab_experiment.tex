...
\begin{table*}[t]
     \caption{Results on trajectory recommendation datasets. The top three rows are baselines, and the bottom four are the methods proposed in this paper. Bolded entries correspond to the \textbf{best} performing method for each metric; italicised entries to the \textit{next best} method. 
...
& \multicolumn{7}{c}{\bf Kendall's $\tau$} \\
\hline
...
\hline
& \multicolumn{7}{c}{\bf F$_1$ score on points} \\ 
\hline
...
\hline
& \multicolumn{7}{c}{\bf F$_1$ score on pairs} \\ 
\hline
