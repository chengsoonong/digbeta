...
\begin{table}[!h]
	\begin{minipage}[t]{\linewidth}
		...
		\textbf{Dataset} & \textbf{\#Traj.} & \textbf{\#POIs} & \textbf{\#Users} & \textbf{\#Queries} & \textbf{\#GroundTruth=1} & \textbf{\#GroundTruth$\in$[2,5]} & \textbf{\#GroundTruth$>$5} & \textbf{\#Traj.(short)} & \textbf{\#Traj.(long)} \\ \hline
        ...
        including the number of trajectories (\textbf{\#Traj.}), the number of POIs (\textbf{\#POIs}), the number of users (\textbf{\#Users}),
        the number of queries (\textbf{\#Queries}); the number of queries with a single ground truth (\textbf{\#GroundTruth=1}),
        the number of queries with 2 to 5 ground truths (\textbf{\#GroundTruth$\in$[2,5]}), and the number of queries with more than 5 ground truths
        (\textbf{\#GroundTruth$>$5}); the number of trajectories with less than 5 POIs (\textbf{\#Traj.(short)}) and the number of trajectories with
        more than 5 POIs (\textbf{\#Traj.(long)}).
        }
		\label{tab:data}
	\end{minipage}%
	%%\quad
	%%\begin{minipage}[t]{0.45\linewidth}
	%%	\includegraphics[scale=0.35]{hist_query.pdf}
...
\begin{minipage}[t]{0.8\linewidth}
		\includegraphics[scale=0.5]{tau_topk.pdf}
