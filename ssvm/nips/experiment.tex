...
\rev{We evaluate four variants of sequence recommendation, using structured prediction models, incorporating multiple valid truths, and path constraints.}
\begin{itemize}[leftmargin=0.125in]\itemmoveup
\parskip -.05em
