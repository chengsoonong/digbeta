...
we want to recommend one or more sequences of POIs (or \emph{trajectories}) %$\mathbf{y}^*$ 
...
As another example, \citep{cikm16paper} proposed the use of the RankSVM model,
