...
Another example of sequential recommendation is the problem of recommending song playlists to users, given a query song~\citep{McFee:2011,chen2012playlist}.
