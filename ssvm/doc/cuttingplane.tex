...
\usepackage[a4paper,top=0.75in,left=0.75in,bottom=0.9in,right=0.52in]{geometry} % A4 paper margins
\usepackage{hyperref}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{bm}
...
\subsubsection{Query generation method}
...
\subsubsection{Explicit objective cut generation}
...
\subsubsection{Generate query point using the method of Kelley-Cheney-Goldstein and the Chebyshev center method}
\label{sec:compare}
...
\subsubsubsection{The $1$-slack formulation}
...
\subsubsubsection{The $n$-slack formulation}
