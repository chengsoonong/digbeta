...
\input{metric/metric_rank}
\input{metric/metric_sequence}

\input{cutting_plane/cutting_plane}
\input{cutting_plane/ssvm}

\input{list_viterbi/forward}
\input{list_viterbi/backward}
\input{list_viterbi/lva_basic}
\input{list_viterbi/lva_2best}
\input{list_viterbi/list_viterbi}
