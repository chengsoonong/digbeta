...
Consider a linear ranking function $f(\x) = \w^\top \x$ and loss function~\ref{eq:loss_inf1}, and define the following notations:
\begin{table}[!h]
\begin{tabular}{ll}
