...
\icmltitlerunning{Learning from Structured Multisets}

\begin{document}

\twocolumn[
\icmltitle{Learning from Structured Multisets}
...
\icmlkeywords{structured prediction, trajectory recommendation}
