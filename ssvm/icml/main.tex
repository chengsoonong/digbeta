...
\icmltitlerunning{Sequence Recommendation via Structured Prediction}

\begin{document}

\twocolumn[
\icmltitle{Sequence Recommendation via Structured Prediction}
