...
i.e., recommending a trajectory that maximises the points ranking of its POIs as well as its likelihood at the same time.
...
One heuristic to find a trajectory that simultaneously maximises the ranking probabilities of its POIs and its likelihood 
