...
and \textsc{Rank+Markov} (Section~\ref{sec:rank+markov}) that incorporates both, %POI features and transition probabilities.
...
Algorithms based on POI rankings yield strong performance, in terms of both metrics, by exploring POI and query specific features.
...
On the contrary, most Markov chain entries have better performance in terms of pairs-F$_1$ (Table~\ref{tab:pairf1}), %as shown in Table~\ref{tab:pairf1},
