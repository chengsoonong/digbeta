...
%LX: not clear what 'discovery mode' means here, don't need this sentence, delete. 
...
This work aims to address both challenges. %bridge these gaps.
...
and POI to POI transitions that are factorised along %five
