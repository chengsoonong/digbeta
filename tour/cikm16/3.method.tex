...
We can learn a ranking of POIs using rankSVM with linear kernel and $L2$ loss~\cite{lranksvm},
\begin{displaymath}
...
$\mathbf{f}_{p_i}$ is the feature vector for POI $p_i$.
...
The frequency distribution of POI popularity, number of visits and visit duration of five datasets are shown in Figure~\ref{fig:distro}.
