...
\subsubsection{Is sequence recommendation helpful?}
...
in particular, the red radar chart shows the decomposition of the first POI (red marker) in the trajectory,
and the green chart shows the decomposition of the third POI (green marker).
We found that popularity and distance related features are the main contributor to the first POI, 
and the third POI is mainly supported by visits and distance related features.
