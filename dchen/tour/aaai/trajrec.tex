...
\multicolumn{1}{|c|}{\bf Challenges} & \multicolumn{1}{c|}{\bf Solutions}          \\ \hline
Global cohesion                    & Structured SVM                             \\ \hline
Multiple ground truths             & Ground truths aggregation in loss \\ \hline
Loop elimination                   & The list Viterbi algorithm                 \\ \hline  
\end{tabular}
\end{table}
