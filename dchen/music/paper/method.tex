...
\cheng{We are recommending a set. How does our loss ignore the ranking order within the positive set?}
...
\cheng{Write this again. Precisely define: $n, m, M, N$. It is very confusing that $m$ goes to $M$ but $i$ goes to $N$.}
...
\cheng{There are two min operators in equation 3. Specify more precisely.}
