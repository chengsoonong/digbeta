...
Figure~\ref{fig:setting} illustrates the three cold-start scenarios for playlist recommendation 
...
of the playlists weights $\betabm_i$ %from the same user
...
However,
%the total 
the number of playlists {\small $N$} can be enormous %very large 
