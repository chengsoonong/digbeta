...
To impose the assumptions we made, we apply L$_1$ regularisation to encourage sparse representations of playlists $\betabm_i$ %from the same user
...
$$
where $\UCal$ is the set of (\eg 10) existing users most similar to the new user.
