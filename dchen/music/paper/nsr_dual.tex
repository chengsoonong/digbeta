...
&= \sum_{i=1}^N \sum_{m: y_m^i = 1} \theta_i^m \left(1 - \log(-\theta_i^m) - \log(N M_+^i) \right) \\
&= \sum_{i=1}^N \sum_{m: y_m^i = 1} \z_m^\top \lambdabm_i \left(1 - \log(-\z_m^\top \lambdabm_i) - \log(N M_+^i) \right) \\
&= \sum_{i=1}^N \sum_{m: y_m^i = 1} \left[ \z_m^\top \lambdabm_i \left(1 - \log(N M_+^i) \right) 
