...
\begin{aligned}
\bv_u
&= -\frac{U}{\lambda} \sum_{i \in P_u} \sum_{m=1}^M \theta_i^m \x_m
 = -\frac{U}{\lambda} \sum_{i \in P_u} \left( \thetabm_i^\top \X \right)^\top \\
%
\w_i
&= -\frac{N}{\lambda} \sum_{m=1}^M \theta_i^m \x_m
 = -\frac{N}{\lambda} \left( \thetabm_i^\top \X \right)^\top \\
%
\mubm
&= -\frac{1}{\lambda} \sum_{i=1}^N \sum_{m=1}^M \theta_i^m \x_m 
 = -\frac{1}{\lambda} \sum_{i=1}^N \left( \thetabm_i^\top \X \right)^\top \\
%
0
&= \sum_{m=1}^M \theta_i^m 
 = \thetabm_i^\top \one_M
