...
In addition to these accuracy related measures, we further adopt two beyond-accuracy measures, \ie
...
and this ability can be measured by \emph{novelty},
$$
...
% spread is a metric of how well the recommender algorithm can spread its attention across a larger set of items,

% it is defined as the entropy of the distribution of the items recommended to the users in the test set.

% spread = -\sum_{m=1}^M P(m) \log P(m),
...
% moderate values are usually preferred.
