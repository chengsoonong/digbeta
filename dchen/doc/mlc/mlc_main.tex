...
we summarise these configurations in Table~\ref{tab:config}.
...
0-1 loss         & 0-1 loss        & LR\tablefootnote{We use log loss to upper-bounded the 0-1 loss in this table.} \\
\bottomrule
\end{tabular}
\end{table}
