...
&= \frac{\llb y_k^n = 0 \rrb} {\lambda N K_-^n} \frac{1}{N K_-^n} 
...
$$
%
Note that the Hessian matrix is \emph{symmetric} according to Schwarz's theorem as $J(\Theta_{1:N})$ is continuous and differentiable,
