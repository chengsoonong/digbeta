...
&= \frac{\lambda}{2} \w_k^\top \w_k + 
   \frac{1}{N} \sum_{n=1}^N -\log \left[ \sigma(\w_k^\top \x^n)^{y_k} (1 - \sigma(\w_k^\top \x^n))^{(1 - y_k)} \right] \\
&= \frac{\lambda}{2} \w_k^\top \w_k + 
   \frac{1}{N} \sum_{n=1}^N \left[ -y_k \log \sigma(\w_k^\top \x^n) - (1 - y_k) \log (1 - \sigma(\w_k^\top \x^n)) \right]
\end{align*}
...
&= \lambda \w_k + \frac{1}{N} \sum_{n=1}^N \left[ -y_k \frac{\sigma(\w_k^\top \x^n) (1 - \sigma(\w_k^\top \x^n)) \x^n} {\sigma(\w_k^\top \x^n)} -
   (1 - y_k) \frac{- \sigma(\w_k^\top \x^n) (1 - \sigma(\w_k^\top \x^n)) \x^n} {1 - \sigma(\w_k^\top \x^n)} \right] \\
&= \lambda \w_k + \frac{1}{N} \sum_{n=1}^N \left[ -y_k \x^n (1 - \sigma(\w_k^\top \x^n)) + (1 - y_k) \x^n \sigma(\w_k^\top \x^n) \right] \\
&= \lambda \w_k + \frac{1}{N} \sum_{n=1}^N \left[ y_k \x^n \right]
\end{align*}
