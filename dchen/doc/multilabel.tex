...
\approx \frac{\llb y_k = 1 \rrb} {K_+} \cdot
  \frac{-\x} {1 + \left[ \exp(-\w_k^\top \x) \left[ \underset{j:y_j=0}{\sum} \exp(r \w_j^\top \x) \right]^{1/r} \right]^{-1} }
$$
...
&\approx \lambda \w_k + \frac{1}{N} \sum_{n=1}^N 
         ...
         \frac{-\x^n} {1 + \left[ \exp(-\w_k^\top \x^n) \left[ \underset{j:y_j^n=0}{\sum} \exp(r \w_j^\top \x^n) \right]^{1/r} \right]^{-1} }
\end{align*}
